...
EXPORT_POSTGRES_HOST = os.getenv("EXPORT_POSTGRES_HOST", POSTGRES_HOST)
EXPORT_POSTGRES_PORT = int(os.getenv("EXPORT_POSTGRES_PORT", str(POSTGRES_PORT)))
EXPORT_POSTGRES_DB = os.getenv("EXPORT_POSTGRES_DB", POSTGRES_DB)
EXPORT_POSTGRES_USER = os.getenv("EXPORT_POSTGRES_USER", POSTGRES_USER)
EXPORT_POSTGRES_PASSWORD = os.getenv("EXPORT_POSTGRES_PASSWORD", POSTGRES_PASSWORD)
EXPORT_POSTGRES_SSLMODE = os.getenv("EXPORT_POSTGRES_SSLMODE", POSTGRES_SSLMODE).strip()
EXPORT_POSTGRES_SCHEMA = os.getenv("EXPORT_POSTGRES_SCHEMA", "public")
EXPORT_POSTGRES_TABLE = os.getenv("EXPORT_POSTGRES_TABLE", "audience_export_staging")
...
INTEGRATION_READINESS_PROBE_TIMEOUT_SECONDS = max(
    0.1, float(os.getenv("INTEGRATION_READINESS_PROBE_TIMEOUT_SECONDS", "2.0"))
)
